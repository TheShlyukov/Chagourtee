...
function createDb(dbPath) {
  ...
  db.serialize(() => {
    ...
    db.run(`CREATE INDEX IF NOT EXISTS idx_messages_created_at ON messages(room_id, created_at);`);
    db.run(`CREATE INDEX IF NOT EXISTS idx_messages_updated_at ON messages(updated_at);`);
  });
